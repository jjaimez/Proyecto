...
public class ObjectOwner {
	 ...
	 * @param realEstates
	 */
	public ObjectOwner(String firstName, String lastName, String dni,String email, String city, int code, String street, String num,String neighborhood,List<String> realEstates) {

...
public class ABMBuilding {
	...
	//retorna un ObjectBuilding a traves de una calle, numero e identificadior de ciudad de un edificio
	public static ObjectBuilding consultBuilding(String street, String num, int city_id){
		...
		return toObject(building);
	}//end consultBuilding		
	
	
	public static ObjectBuilding toObject(Building building){
	...
	// retorna un ObjectBuilding a traves del identificador de un edificio
...
//-------------------MODIFICACIONES------------------------------------------------------	
	...
	public void updatePrice(String street, String num, int code, int newPrice){
		int idCity= City.findByCode(code).getInteger("id"); // saco el id de la ciudad
		Building building= Building.findByBuilding(street, num, idCity);
		if (building!=null){

...
public class Building extends Model {
	static{
		//valido que el price,addres_id,type, offer sean obligatorios
	...
	//crea un edificio
	public static Building createBuilding(Address address,String description,int price,String offer,String type,Owner owner, RealEstate realEstate){
  		Building building= create("description",description,"price",price,"offer",offer, "type", type);
